export class ProjectController {
    ...
    createProject = async (req, res, next) => {
        try {
            ...
            const projectBodyDto = req.body;
            const newProject = await this.projectService.createProject(userId, projectBodyDto);
    ...
    getProjectById = async (req, res, next) => {
        try {
            ...
            const projectDetails = await this.projectService.getProjectDetails(userId, projectId);
    ...
    updateProject = async (req, res, next) => {
        try {
            ...
            const updateProject = await this.projectService.updateProject(userId, projectId, projectBodyDto);
