...
router.post(
  ...
  validateCreateSubtask,
  subtaskController.createSubtask.bind(subtaskController)
);
...
router.patch(
  "/subtasks/:id/status",
  subtaskController.toggleSubtaskStatus.bind(subtaskController)
);

// 삭제
router.delete(
  "/subtasks/:id",
  subtaskController.deleteSubtask.bind(subtaskController)
);
